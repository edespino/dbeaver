...
/**
 * Cloudberry table manager
 */
public class CloudberryTableManager extends PostgreTableManager {
    @Override
    protected CloudberryTable createDatabaseObject(@NotNull DBRProgressMonitor monitor,
                                                  @NotNull DBECommandContext context,
                                                  Object container,
                                                  Object copyFrom, @NotNull Map<String, Object> options) {
        CloudberryTable cloudberryTable = new CloudberryTable((PostgreSchema) container);
        setNewObjectName(monitor, (PostgreSchema) container, cloudberryTable);

        return cloudberryTable;
    }
