...
/**
 * CloudberryCharacterSet
 *
 * Supported as of Cloudberry 5.x (http://gpdb.docs.pivotal.io/500/ref_guide/character_sets.html)
 */
public enum CloudberryCharacterSet {
    BIG_FIVE("BIG5"),
    ...
    CloudberryCharacterSet(String characterSet) {
