...
public class CloudberryFunction extends PostgreProcedure {
    private FunctionExecLocation executionLocation;

    public CloudberryFunction(PostgreSchema schema) {
        super(schema);
        this.executionLocation = getDataSource().isServerVersionAtLeast(9,4) ? FunctionExecLocation.a : null;
    }

    public CloudberryFunction(DBRProgressMonitor monitor, PostgreSchema schema, ResultSet dbResult) {
