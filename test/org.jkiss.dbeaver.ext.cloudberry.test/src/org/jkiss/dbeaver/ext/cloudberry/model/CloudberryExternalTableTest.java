...
public class CloudberryExternalTableTest {
    @Mock
    ...
    public void onCreation_whenNoInitialDbResultIsProvided_thenDefaultEncodingIsSetToUTF8() {
        CloudberryExternalTable table = new CloudberryExternalTable(mockSchema);
    ...
    public void onCreation_readsASingleUriLocationFromDbResult() throws SQLException {
        ...
        CloudberryExternalTable table = new CloudberryExternalTable(mockSchema, mockResults);
    ...
    public void onCreation_readsRejectLimitTypeFromDBResult() throws SQLException {
        ...
        CloudberryExternalTable table = new CloudberryExternalTable(mockSchema, mockResults);
        Assert.assertEquals(CloudberryExternalTable.RejectLimitType.r, table.getRejectLimitType());
    }
    ...
    @Test
    public void onCreation_setsDefaultLoggingErrorsToFalse_ifCloudberryServerVersionIs6andAbove() throws SQLException {
    ...
    private void addMockColumnsToTableCache(List<PostgreTableColumn> tableColumns, CloudberryExternalTable table)
            throws DBException {
