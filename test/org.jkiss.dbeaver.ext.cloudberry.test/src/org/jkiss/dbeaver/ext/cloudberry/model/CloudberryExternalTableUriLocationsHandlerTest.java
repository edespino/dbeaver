...
public class CloudberryExternalTableUriLocationsHandlerTest {
    @Test
    public void getCommaSeparatedList_whenConstructedWithALineFeedSeparatedListOfLocations_shouldReturnCommaSeparatedString() {
        CloudberryExternalTableUriLocationsHandler handler =
                new CloudberryExternalTableUriLocationsHandler("location1\nlocation2", '\n');
